      ...
      <div className="privacy-outer-container">
        ...
        <article className="privacy-inner-container">
          <p>
            ...
            adhere to the following basic principles: We employ the highest
            levels of security to keep your personal information strictly
            confidential. We will not disclose or sell any of your personal
            information, including your name, address, age, sex or medical
            history to any third party without your permission.
          </p>
          <p>
            ...
            <a
              style={{ color: "black" }}
              href="mailto:yogmhospital22@gmail.com"
            >
          ...
          <p>
            What information we collect from you How we use that information
            Your privacy is of utmost importance to us . If you have any
          ...
          <p>
            ...
            - We collect device-specific information such as device make &
            model, network information, advertiser ID (to uniquely identify your
            device) and email address, if available Location information - We
            automatically capture your public IP address, and your geo
            coordinates
          </p>
        </article>
      </div>
